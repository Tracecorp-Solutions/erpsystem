  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center bg-white rounded-3xl max-w-[820px]">
        ...
        <div className="justify-between px-5 pt-4 pb-5 mt-8 max-w-full w-[500px]">
          <div className="flex gap-5 max-md:flex-col max-md:gap-0">
            ...
            <div className="flex flex-col ml-5 w-[49%] max-md:ml-0 max-md:w-full">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/e8dd15a007798c0ac8b43df978931898837b98a2f2a6986c39022ce4de490c93?apiKey=0d95acea82cc4b259a61e827c24c5c6c&"
            ...
            <div className="flex flex-col ml-5 w-3/12 max-md:ml-0 max-md:w-full">
              <div className="flex flex-col grow text-neutral-400 max-md:mt-4">
                ...
                <div className="mt-2 text-sm text-center">Ticket Details</div>
              </div>
            </div>
          </div>
        </div>
