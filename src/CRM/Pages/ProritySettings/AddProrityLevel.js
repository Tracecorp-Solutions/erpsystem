...
return (
  <div className="flex flex-col items-center pb-20 text-base font-semibold leading-6 max-w-[820px] text-neutral-600">
    ...
    <div className="mt-8 max-md:max-w-full">Priority Level Name</div>
    ...
    <div className="mt-4 max-md:max-w-full">Color Code</div>
    ...
    <div className="mt-4 max-md:max-w-full">Description</div>
