...
const steps = [
  ...
  { name: 'Profile information', description: 'Cursus semper viverra facilisis et et some more.', href: '#', status: 'current' },
...
const Profile = () => {
  return (
    <div className="flex h-screen">
      {/* Sidebar Navigation */}
      <nav aria-label="Progress" className="flex-shrink-0 w-64 bg-gray-200">
