...
const SurveyorReport = ({
  ...
  const handleSubmit = () => {
    // Example logic to handle submission
    console.log("Date of Survey:", dateOfSurvey);
    console.log("Proceed with installation option:", installationOption);
    // Additional logic here to submit the report
  ...
  const questions = [
    {
      ...
      description:
        "What is the distance (in meters) from the main line to the premises to be connected?",
    },
    {
      title: "Land Type",
      description:
    ...
    },
    {
      title: "Obstructions",
      description:
        "Are there any obstructions between the main line and the premises? If yes, please list them.",
    },
    {
    ...
    },
    {
      ...
      description:
        "What is the size (in inches) of the existing main line to be tapped?",
    },
    {
      title: "Service Pipe Depth",
      description:
        "What is the suggested depth (in feet) for the service pipe below ground level?",
    },
    {
      title: "Connection from Existing Service Pipe",
      description:
        "Is the customer connecting from another customer’s existing service pipe?",
    },
    {
      title: "Existing Connections",
      description:
        "Does the customer have any other connections with the corporation?",
    },
    {
    ...
    },
    {
      ...
      description:
        "Is there any nearby customer? If yes, please provide their reference number, name, and meter number",
    },
    {
    ...
    },
    {
      ...
      description:
        "What is the type and size (in inches) of the main line to be connected?",
    },
    {
      title: "Road Information",
      description:
        "What type of road (if any) will be affected, and what is its width?",
    },
    {
      title: "Recommendations",
      description:
        "What do you recommend for the next action depending on your findings?",
    },
  ];
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center bg-white rounded-3xl max-w-[820px]">
        <header className="flex flex-col self-stretch pt-6 w-full text-4xl font-semibold leading-[57.6px] text-neutral-600 max-md:max-w-full"></header>
        ...
        <main className="justify-between px-5 pt-4 pb-5 mt-4 max-w-full w-[500px]">
          ...
          <section>
            ...
            <div>
              <DatePicker
                ...
                style={{ width: "100%" }}
                className="flex gap-2 justify-between px-4 py-4 mt-2 max-w-full text-base leading-6 bg-white rounded-xl border border-solid border-neutral-500 border-opacity-30 text-neutral-400 w-[500px] max-md:flex-wrap"
              />
            </div>
          ...
          <section>
            ...
            <div className="px-4 py-4">
              <div className="text-base font-semibold leading-6 text-gray-700 mb-2">
              ...
              <select
                ...
                <option value="delay">Delay installation</option>
                <option value="cancel">Cancel installation</option>
              </select>
            </div>
          </section>
