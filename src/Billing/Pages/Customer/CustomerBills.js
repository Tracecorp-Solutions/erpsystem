      ...
      <div className="flex flex-col p-6 mt-6 bg-white rounded-3xl max-md:px-5 max-md:max-w-full">
        ...
        <div className="flex gap-5 justify-between px-6 py-3.5 mt-4 w-full text-xs font-medium tracking-wide uppercase rounded-3xl bg-stone-100 text-neutral-400 max-md:flex-wrap max-md:px-5 max-md:max-w-full">
          <div className="flex gap-5 justify-between items-center max-md:flex-wrap max-md:max-w-full">
            ...
            <div className="self-stretch my-auto">BILLING DATE</div>
          </div>
        ...
        <div className="flex gap-5 justify-between items-center px-6 py-2 mt-2 w-full rounded-3xl max-md:flex-wrap max-md:px-5 max-md:max-w-full">
          ...
          <div className="flex gap-5 justify-between self-stretch px-px my-auto text-base leading-6 text-neutral-600 max-md:flex-wrap">
            ...
            <div className="justify-center bg-white">Ogun Billing</div>
          </div>
          <div className="flex justify-center items-center self-stretch px-1.5 w-8 h-8 rounded-3xl bg-stone-100">
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/590f8483c1a2f2cbc8573ad37265fabde0d620594ca7d504e906de415c190308?apiKey=5bf51c3fc9cb49b480a07670cbcd768f&"
