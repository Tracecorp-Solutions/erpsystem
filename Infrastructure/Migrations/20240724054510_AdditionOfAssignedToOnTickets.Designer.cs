...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240724054510_AdditionOfAssignedToOnTickets")]
    partial class AdditionOfAssignedToOnTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.CRM.EscalationMatrix", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.CRM.Priority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Models.CRM.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("EscalationMatrixId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TicketSource")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Core.Models.CRM.TicketAuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ReasonOfEscalation")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Core.Models.CRM.EscalationMatrix", b =>
                {
                    ...
                    b.HasOne("Core.Models.CRM.Priority", "Priority")
                        .WithMany()
                        .HasForeignKey("PriorityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.CRM.TicketCategory", "TicketCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Models.CRM.Ticket", b =>
                {
                    ...
                    b.HasOne("Core.Models.CRM.EscalationMatrix", "EscalationMatrix")
                        .WithMany()
