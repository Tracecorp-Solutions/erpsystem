...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240702182406_AdditionOfMeterMakeIdOnMeterServicing")]
    partial class AdditionOfMeterMakeIdOnMeterServicing
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Models.Billing.NewMeterServicing", b =>
                {
                    ...
                    b.Property<int>("MeterTypeNavigationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MeterTypeNavigationId");
            ...
            modelBuilder.Entity("Core.Models.Billing.NewMeterServicing", b =>
                {
                    ...
                    b.HasOne("Core.Models.Billing.MeterMake", "MeterMakeNavigation")
                        .WithMany()
                        .HasForeignKey("MeterMakeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Billing.MeterSize", "MeterSizeNavigation")
                        .WithMany()
                        .HasForeignKey("MeterSizeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Models.Billing.MeterTypes", "MeterTypeNavigation")
                        .WithMany()
                        .HasForeignKey("MeterTypeNavigationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MeterMakeNavigation");

                    b.Navigation("MeterSizeNavigation");

                    b.Navigation("MeterTypeNavigation");
